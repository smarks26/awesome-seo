# Awesome SEO [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

> A curated list of the best free SEO, AEO, and GEO tools and resources for the modern search landscape.

-----

## 🏛️ Core Essentials

*The "Source of Truth" tools directly from the search engines.*

  * **[Google Search Console](https://search.google.com/search-console/about)** – The gold standard for real search queries, indexing data, and mobile usability.
  * **[Bing Webmaster Tools](https://www.bing.com/webmasters/about)** – Includes unique site health insights and a robust keyword research tool.
  * **[Google Analytics 4](https://analytics.google.com/)** – Essential for tracking user behavior and conversion attribution.
  * **[Google Business Profile](https://www.google.com/business/)** – The core of Local SEO/AEO; essential for Google Maps and the "Snack Pack."

-----

## 🤖 AEO & GEO (AI Search Optimization)

*Optimizing for the "AI Answer" era: ChatGPT, Perplexity, and AI Overviews.*

  * **[AEOEngine.ai](https://aeoengine.ai/aeo-tools)** – Offers a **100% free AEO audit** scanning your site against 75+ prompts to check AI citations.
...
*Discovering what your audience (and the AI) is looking for.*

  * **[Google Keyword Planner](https://ads.google.com/home/tools/keyword-planner/)** – The industry source for raw search volume.
...
## 🏗️ Technical Auditing & Speed

*Fixing the "under-the-hood" issues that block rankings and AI indexing.*

  * **[Screaming Frog SEO Spider](https://www.screamingfrog.co.uk/seo-spider/)** – **Free up to 500 URLs**; the industry standard for identifying broken links and duplicate tags.
...
## ✍️ Content Optimization & AI Tools

*Making your pages attractive to both bots and humans.*

  * **[Yoast SEO (Free)](https://yoast.com/)** – Standard WordPress plugin for basic on-page checks.
  * **[eesel AI Blog Writer](https://www.eesel.ai/)** – Generates SEO-optimized articles; often offers a free trial or initial credits.
...
*Free education to keep your skills sharp.*
...
*SEO data on the fly while you browse.*

  * **[MozBar](https://moz.com/products/pro/seo-toolbar)** – Instant Domain Authority (DA) and Page Authority (PA).
  * **[SEOquake](https://www.seoquake.com/)** – Fast diagnostics, link counts, and SERP overlays.

-----

## Contribute

Contributions are welcome! If you know of a high-quality free resource, please submit a PR.
